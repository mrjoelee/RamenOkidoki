    ...
    public class DashboardViewModel
    {
        ...
        public DashboardViewModel()
        {
            ...
            Reviews = new List<Review>()
            {
                ...
                new Review( "AD Avenue G.", "Good taste. Staff is friendly clean place. I took the tonkotsu ramen with an extra egg. Delicious.", 5),

                new Review( "Lv126 M.", "Great ramen for a good price. I recommend coming here.", 5),
