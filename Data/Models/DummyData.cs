...
namespace Data.Models
{
    public class DummyData
    {
        ...
        public static List<CustomerReview> GetReviews()
        {
            return new List<CustomerReview>()
            {
                new CustomerReview("Mario P.",
                ...
                new CustomerReview("AD Avenue Group",
                    "Good taste. Staff is friendly clean place. I took the tonkotsu ramen with an extra egg. Delicious.",
                    5, "June 2021"),

                new CustomerReview("Lv126 M.", "Great ramen for a good price. I recommend coming here.", 5, "August 2021"),

                new CustomerReview("Sharon Ree",
                ...
                new CustomerReview("Stephanie D.",
        ...
        public static List<CarouselImage> GetCarouselImages()
        {
